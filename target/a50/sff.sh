...
# Bixby - Optimized for A50 (Power Key Trigger)
...
SEC_FLOATING_FEATURE_LCD_CONFIG_CONTROL_AUTO_BRIGHTNESS=1
...
SEC_FLOATING_FEATURE_LOCKSCREEN_CONFIG_PUNCHHOLE_VI=center,pos:0.5:0.02,size:0.1:0.05,type:u_notch
SEC_FLOATING_FEATURE_LOCKSCREEN_CONFIG_SUBDISPLAY_POLICY=

# Fingerprint sensor
SEC_FLOATING_FEATURE_BIOAUTH_CONFIG_FINGERPRINT_FEATURES=optical_touch_display

# Device
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_BRAND_NAME=Galaxy A50
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A3LSMA505FN
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_ELECTRIC_RATED_VALUE=DC 9 V; 1.67 A
SEC_FLOATING_FEATURE_SYSTEM_CONFIG_SIOP_POLICY_FILENAME=siop_a50_exynos9610

# Camera - Optimized for A50 (Exynos 9610)
...
SEC_FLOATING_FEATURE_CAMERA_CONFIG_IS_GPPM_1_0_ENABLED=FALSE
SEC_FLOATING_FEATURE_CAMERA_CONFIG_WINE_DETECTOR=OFF
SEC_FLOATING_FEATURE_CAMERA_GRAW_CONFIG_MFP_PIPELINE_MODE=V1
SEC_FLOATING_FEATURE_CAMERA_CONFIG_SDK_FEATURE_INFO=version2,super_night,preview_dis,video_hdr,smooth_zoom
SEC_FLOATING_FEATURE_CAMERA_CONFIG_UW_DISTORTION_CORRECTION=0,119,2,18010101,3264,2448,0,0,0,0
SEC_FLOATING_FEATURE_CAMERA_CONFIG_VENDOR_LIB_INFO=beauty.samsung.v4,human_tracking.arcsoft.v2_1,face_landmark.arcsoft.v2_1,facial_attribute.samsung.v1,smart_scan.samsung.v2,selfie_correction.samsung.v1,swuwdc.arcsoft.v1,scene_detection.samsung.v1,event_detection.samsung.v2,single_bokeh.samsung.v2,human_segmentation.samsung.v2,super_night.mpi.v2,mfhdr.mpi.v1,llhdr.mpi.v1,food.samsung.v1,localtm.samsung.v1_1,image_codec.samsung.v1
...
SEC_FLOATING_FEATURE_CAMERA_SUPPORT_30FPS_ALL_PORTRAITVIDEO=FALSE
...
SEC_FLOATING_FEATURE_COMMON_CONFIG_SWLENS_DISTORTION_CORRECTION=a50
